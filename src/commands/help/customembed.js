...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addChannelOption((option) =>
      option.setName("channel").setDescription("The channel to echo to")
    ),
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: "NBCC WMAD & GEX",
          iconURL:
            "https://scontent-lga3-1.xx.fbcdn.net/v/t39.30808-6/350353523_990049728673372_9163496265846603301_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=y8jz95jr_7oAX_1hEYn&_nc_ht=scontent-lga3-1.xx&oh=00_AfB2a4rbCIN6m8yUnSA9RrgLq6TrP59-hW2bMmnAPW_0dQ&oe=64E9E9DA",
        })
        .setTimestamp();
